...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   * Retorna o valor concatenado. Trata separador decimal
  ...
  definirOperacao(operacao: string): void {
    ...
    //caso tenha operacao e o número 2 selecionado, efetua o cálculo
  ...
  /**
   * Retorna valor a ser devolvido na tela da calculadora
   * return string
   */
  get display (): string {
